...
const Search: React.FC<SearchProps> = ({ search, setSearch }) => {
  ...
  return (
    <form
      className="lg:w-1/3 md:w-2/3 xl:w-1/3 w-full mx-auto p-5 py-16"
      action={handleSearch}>
